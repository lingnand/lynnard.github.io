...
**Update: I've formally made a package called *VIMonad* with all the features discussed here (as well as other more interesting ones) [here](http://vimonad.lynnard.me).**
